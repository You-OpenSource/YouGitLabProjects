package com.github.yougitlabprojects.common;
...
public abstract class GitLabApiAction extends DumbAwareAction {
    ...
    public static boolean validateGitLabApi(@NotNull Project project, VirtualFile virtualFile) {
        ...
        if(!isOk) {
            MessageUtil.showErrorDialog(project, "Cannot log-in to GitLab Server with provided token", "Cannot Login To GitLab");
        }
        return isOk;
    }
