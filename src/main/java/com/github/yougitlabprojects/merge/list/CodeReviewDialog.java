...
import com.github.yougitlabprojects.comment.CommentsDialog;
import com.github.yougitlabprojects.comment.GitLabCommentsListWorker;
        ...
        assignMe.addActionListener(event -> {
            GitLabUtil.computeValueInModal(project, "Changing assignee...", (Convertor<ProgressIndicator, Void>) o -> {
                try {
                    ...
                    MessageUtil.showErrorDialog(project, "Cannot change assignee of this merge request.", "Cannot Change Assignee");
                }
                return null;
            });
        });
