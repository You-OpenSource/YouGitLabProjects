package com.github.yougitlabprojects.share;

import com.github.yougitlabprojects.common.GitLabIcons;
import com.github.yougitlabprojects.common.NoGitLabApiAction;
import com.github.yougitlabprojects.configuration.SettingsState;
import com.github.yougitlabprojects.api.dto.NamespaceDto;
...
public class GitLabShareAction extends NoGitLabApiAction {
    ...
    public void shareProjectOnGitLab(@NotNull final Project project, @Nullable final VirtualFile file) {
        ...
        if (gitDetected) {
            ...
            if (gitLabRemoteUrl != null) {
                MessageUtil.showInfoMessage(project, "This project already has remote to your GitLab Server", "Already Git Lab Project");
            }
        }
        ...
        ProgressManager.getInstance().run(new Task.Backgroundable(project, "Sharing to GitLab...") {
            ...
            public void run(@NotNull ProgressIndicator indicator) {
                ...
                if (repository == null) {
                    MessageUtil.showErrorDialog(project, "Remote server was not found.", "Remote Not Found");
                    return;
                }
                ...
                MessageUtil.showInfoMessage(project, "Project was shared to your GitLab server", "Project Shared");
    ...
    private static boolean performFirstCommitIfRequired(@NotNull final Project project,
        ...
        try {
            ...
            MessageUtil.showErrorDialog(project, "Project was create on GitLab server, but files cannot be commited to it.", "Initial Commit Failure");
            return false;
        }
        return true;
    }
    ...
    private static boolean pushCurrentBranch(@NotNull Project project,
        ...
        if (currentBranch == null) {
            MessageUtil.showErrorDialog(project, "Project was create on GitLAb server, but cannot be pushed.", "Cannot Be Pushed");
            return false;
        }
